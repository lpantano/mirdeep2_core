...
system("$scripts/convert_bowtie_output.pl $dir/reads_vs_precursors.bwt > $dir/reads_vs_precursors.arf");
...
if($options{a}){
    ...
    system("$scripts/convert_bowtie_output.pl $dir/mature_vs_precursors.bwt > $dir/mature_vs_precursors.arf");
